...
<body>
  ...
  <div>
    ...
    <div>
    <p> <h2 style="margin-left: 80px">PS4</h2> </p>
    <pre><img src="digital/ps4.png" alt="PS4" style="width: 20%; margin-left: 80px;" />
    <p> <h2 style="text-align:left; margin-left: 80px">Batman Arkham Knight Ps4 </h2> </p>
    ...
    <div>
    <p> <h2 style="margin-left: 80px">XBOX</h2> </p>
    <pre><img src="digital/xbox.png" alt="XBOX"  style="width: 20%; margin-left: 80px;">
    <p> <h2 style="text-align:left; margin-left: 70px">Xbox one X</h2> </p>
    <div style="margin-left: 60px;padding: 5px">
    <button type="button" onClick="document.location.href='viewdetailall.php'">View Details</button> 
    </div>
