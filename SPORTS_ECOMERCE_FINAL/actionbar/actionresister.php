...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (isset($_POST["psw_repeat"]) & !empty($_POST["psw-repeat"])) {
  ...
  if($counter == 0) {
    ...
    $user = fopen("C:xampp\htdocs\WT\Webtech\SportsE-commerce\Viewfiles\Datafiles\customer.txt", "w") or die("Unable to open file!");
...
<div style="display:inline-block;">
  ...
  <div>
    ...
    <div>
      <button type="button" onClick="document.location.href='http://localhost/WT/SPORTS_ECOMERCE_FINAL/homepagefinal.html'">Cancel</button>
      <button type="button" onClick="document.location.href='http://localhost/WT/SPORTS_ECOMERCE_FINAL/homepagefinal.html'">Login</button>
